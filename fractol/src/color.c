...
/*   Updated: 2020/01/17 17:50:57 by anystrom         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static t_color		color_set(int set, double t, t_color color)
{
	...
	{
		color.one = (0 * pow((1 - t), 1) * pow(t, 4) * 255);
		color.two = (5 * pow((1 - t), 2) * pow(t, 3) * 255);
		color.three = (10 * pow((1 - t), 3) * pow(t, 2) * 255);
		color.four = (15 * pow((1 - t), 4) * pow(t, 1) * 255);
	}
	return (color);
}
